    ...
    <div className="relative" ref={containerRef}>
      <div className="relative">
        <input
          ...
          disabled={disabled}
          className="w-full px-4 py-2 pl-10 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 disabled:bg-gray-100 disabled:cursor-not-allowed"
        />
