...
- **Docker Compose** deployment to a single EC2 (e.g. `your-ec2-hostname-or-ip`) with Postgres and Redis in containers
...
*If you already have an EC2 instance (e.g. `your-ec2-hostname-or-ip`), skip to Step 2.6 to verify/update security groups and networking.*
...
```bash
ssh -i "givingshelf-key.pem" ec2-user@your-ec2-hostname-or-ip
```
